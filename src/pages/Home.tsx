...
export default function Home() {
  ...
  const expData: Record<ExpTab, { period: string; role: string; org: string; note: string }[]> = {
    realEstate: [
      ...
      { period: "2017 – 2024", role: "CEO — Projects & Business Acquisition", org: "Ananta Spa & Resorts", note: "Delivered 160-key resort at Sariska, 250-villa development in Jaipur, 87-room resort at Goa, 60-room acquisition at Gir. Currently executing 352-key project at Karjat near Mumbai — all on innovative lease-back and co-ownership models." },
